...
6) Реализация AVL дерева как функциональной структуры данных (вставка+удаление элемента).

См. пример обычного бинарного дерева в

https://github.com/VeretennikovAlexander/CPP-Public/blob/master/FunctionalDataStructures/BinaryTree.h
